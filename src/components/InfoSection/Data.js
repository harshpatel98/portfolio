...
export const homeObjTwo = {
    ...
    lightTextDesc: false,
    topLine: 'My Skills',
    headline: 'Do you know your logos?',
    description:
    'Here I have highlighted some of my skills in the software world, with my point of interest being in Web Design. Scroll down to see some of my projects, or visit my github.',
    buttonLabel: 'My Github',
    imgStart: false,
    img: require('../../images/skills.jpg'),    alt: 'skills',
    dark: false,
    primary: false,
    darkText: true,
